package com.sample.aliDirectPay.aliPay.config;
...
//↑↑↑↑↑↑↑↑↑↑请在这里配置防钓鱼信息，如果没开通防钓鱼功能，为空即可 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
	...
	static {
		try {
			...
			String filePath = new AlipayConfig().getClass().getResource("/").getPath() + "basesource.properties";
			InputStream in = new BufferedInputStream(new FileInputStream(filePath));
			p.load(in);
			notify_url = p.getProperty("ali_notify_url");
			return_url = p.getProperty("ali_return_url");
